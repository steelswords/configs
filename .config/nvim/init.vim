...
" Coc settings
let g:coc_global_extensions = ['coc-json', 'coc-sh', 'coc-git', 'coc-pyright', 'coc-clangd',  'coc-cmake', 'coc-docker', 'coc-go', 'coc-jedi', 'coc-rust-analyzer']
set signcolumn=yes
